...
| <img src="skills/svg-to-3d-forge/assets/icon-small.svg" width="26" alt="SVG To 3D Forge" /><br/>[`svg-to-3d-forge`](https://github.com/Arnie016/codex-goated-skills/tree/main/skills/svg-to-3d-forge) | Scaffolds simple SVG assets and turns them into local STL, OBJ, or GLB exports with an explicit Blender extrusion workflow | `svg-to-3d-forge` |
