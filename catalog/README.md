...
- [`gain-tracker`](https://github.com/Arnie016/codex-goated-skills/tree/main/skills/gain-tracker): Track git or output gains against a historical baseline and a target multiplier.
